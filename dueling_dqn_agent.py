...
from model import QDuelingNetwork
...
class Dueling_DQN_Agent():
    ...
    def __init__(self, lr, state_size, action_size, seed):
        ...
        # Q-Network
        self.qnetwork_local = QDuelingNetwork(
            state_size, action_size, seed).to(device)
        self.qnetwork_target = QDuelingNetwork(
            state_size, action_size, seed).to(device)
    ...
    def act(self, state, eps=0.):
        ...
        with torch.no_grad():
            ...
            # action_values, test = self.qnetwork_local(state)
